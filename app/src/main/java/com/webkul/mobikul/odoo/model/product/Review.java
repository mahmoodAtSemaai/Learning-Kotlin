...
//    }
    ...
    public boolean isFormValidated() {
        ...
        Fragment fragment = ((ProductActivity) mContext).getSupportFragmentManager().findFragmentByTag(AddProductReviewFragment.class.getSimpleName());
        if (fragment != null && fragment.isAdded()) {
            AddProductReviewFragment addProductReviewFragment = (AddProductReviewFragment) fragment;
