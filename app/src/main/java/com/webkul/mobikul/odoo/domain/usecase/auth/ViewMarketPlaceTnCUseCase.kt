...
class ViewMarketPlaceTnCUseCase @Inject constructor(private val termsConditionRepository: TermsConditionRepository) {

    operator fun invoke(): Flow<Resource<TermsAndConditionsEntity>> = flow {

        emit(Resource.Loading)
        val result = termsConditionRepository.getSellerTerms()
