...
//    private static final int ANIMATION_DURATION_LONG = 800;
    ...
    @TargetApi(21)
    private static void circleRevealView(View view, int duration) {
    ...
    @TargetApi(21)
    private static void circleHideView(final View view, int duration, AnimatorListenerAdapter listenerAdapter) {
        // get the center for the clipping circle
        int cx = view.getWidth();
        int cy = view.getHeight() / 2;
...
//        anim.setStartDelay(200);
     ...
     * @param duration How long should the animation take, in millis.
     */
    private static void fadeOutView(final View view, int duration) {
