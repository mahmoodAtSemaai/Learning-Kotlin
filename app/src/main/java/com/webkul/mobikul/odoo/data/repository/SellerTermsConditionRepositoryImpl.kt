...
import com.webkul.mobikul.odoo.data.remoteSource.remoteDataSource.SellerTermsConditionRemoteDataSource
...
class SellerTermsConditionRepositoryImpl @Inject constructor(
    remoteDataSource: SellerTermsConditionRemoteDataSource
) : SellerTermsConditionRepository,
